  ...
  const loadingComponent = (
    <div className="flex items-center justify-center min-h-[50vh]">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-gray-600 dark:text-gray-300">Loading task listings...</p>
      </div>
    </div>
  );
      ...
      >
        <div className="flex items-center space-x-3 mb-4">
          <div className="bg-indigo-100 dark:bg-indigo-900/30 p-2 rounded-full">
            <HiPuzzle className="h-6 w-6 text-indigo-600 dark:text-indigo-400" />
          </div>
          <h1 className="text-3xl font-bold">Task Listings</h1>
        </div>
        <p className="text-gray-600 dark:text-gray-400">
          Manage your published micro-tasks and track student performance.
        </p>
      </motion.div>
      
      <Card className="p-6">
        <h2 className="text-xl font-semibold mb-4">Your Task Listings</h2>
        <p>Task listings will be implemented here.</p>
      </Card>
    </div>
  );
}
