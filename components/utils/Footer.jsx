...
const Footer = () => {
  return (
    <div className="mt-16">
      <footer
        className="wow fadeInUp relative z-10 bg-gray-200 bg-opacity-5 pt-16 text-black mt-auto"
        data-wow-delay=".1s"
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                "Craft your perfect getaway with ease, from tailored itineraries to seamless bookings. Your passport to stress-free travel planning awaits with our intuitive app."
                </p>
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="/plan"
                      className="mb-4 inline-block text-base font-medium text-black hover:text-black"
                    >
                      {" "}
                      Plan a trip{" "}
                    </a>
              ...
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a
                      href="/"
                      className="mb-4 text-black inline-block text-base font-medium text-body-color hover:text-primary"
                    >
                      {" "}
                      Privacy Policy{" "}
                    </a>
                  ...
                  <li>
                    <a
                      href="/"
                      className="mb-4 inline-block  font-medium text-black hover:text-black"
                    >
                      {" "}
                      Refund Policy{" "}
                    </a>
